const LOOKBOOK_BASE = [
    ...
    {name:'烤黃瓜', mat:'黃瓜', satiety:10, hydration:-50},
    ...
    {name:'頑皮蠑螈飼料*20', mat:['黃豆飼料包' ,'彈塗魚飼料包','優質肉塊'], category:'飼料', building:'烹飪鍋'},
    {name:'大頑皮蠑螈飼料*30', mat:['黃豆飼料包' ,'彈塗魚飼料包','稀有肉塊'], category:'飼料', building:'烹飪鍋'},
    {name:'高山嵐羊飼料*60', mat:['絳紫果實' ,'黃豆飼料包','旋嵐草'], category:'飼料', building:'烹飪鍋'},
    {name:'秘法靈龍飼料*25', mat:['絳紫果實' ,'帝王蟹','藍蓮飼料包'], category:'飼料', building:'烹飪鍋'},
    {name:'魔法靈龍飼料*20', mat:['絳紫果實' ,'大閘蟹','藍蓮飼料包'], category:'飼料', building:'烹飪鍋'},
    ...
    {name:'藍菇大蝦包', mat:['大龍蝦','小麥','藍蘑菇'], satiety:105,effect: '耐熱', category:'吃的', building:'烹飪鍋'},
    ...
    {name:'紅燒茄子', mat:['薑','茄子','青椒'], satiety:60, category:'吃的', building:'烹飪鍋'},
    {name:'糖醋茄子', mat:['茄子','甘蔗'], satiety:50, category:'吃的', building:'烹飪鍋'},
    {name:'地三鮮', mat:['茄子','土豆','青椒'], satiety:60, category:'吃的', building:'烹飪鍋'},
    {name:'拍黃瓜', mat:['黃瓜','辣椒'], satiety:70, category:'吃的', building:'烹飪鍋'},
    {name:'黃瓜炒蛋', mat:['黃瓜','生雞蛋'], satiety:40, category:'吃的', building:'烹飪鍋'},
    {name:'黃瓜炒肉', mat:['黃瓜','生豬排'], satiety:40, category:'吃的', building:'烹飪鍋'},
    {name:'紫蘇煎黃瓜', mat:['黃瓜','紫蘇'], satiety:50, category:'吃的', building:'烹飪鍋'},
    {name:'薄荷糕', mat:['薄荷','小麥','蜂蜜'], satiety:50, category:'吃的', building:'烹飪鍋'},
    {name:'薄荷玉米粥', mat:['薄荷','玉米','玫瑰茄'], satiety:50, hydration:20, category:'吃的', building:'烹飪鍋'},
    {name:'紫蘇桂魚', mat:['紫蘇','桂魚','薑'], satiety:70, category:'吃的', building:'烹飪鍋'},
    {name:'紫蘇小炒雞', mat:['紫蘇','生雞腿','辣椒'], satiety:80, category:'吃的', building:'烹飪鍋'},
];